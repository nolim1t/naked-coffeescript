powered_by = (req, res, next) ->
	...
	if req.originalUrl.indexOf('/api') != -1
		...
		error_code = 404
		payload = {meta: error_code, data: [], info: {method: req.method, endpoint: req.originalUrl.replace('/api/','').split('?')[0], params: req.params, bodyparams: req.body}, error: [{message: "Invalid endpoint or method", type: "404NotFound"}]}		
